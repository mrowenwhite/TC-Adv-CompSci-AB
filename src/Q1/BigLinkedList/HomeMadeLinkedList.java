...
public class HomeMadeLinkedList<T extends Number & Comparable<T>> implements Iterable<T> { // fancy BS that means <T> is a number that I can iterate with or whatever.
    ...
    public HomeMadeLinkedList<T> getReverse() {
        HomeMadeLinkedList<T> r = new HomeMadeLinkedList<>();
