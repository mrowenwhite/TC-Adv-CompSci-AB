package Sem1.BigDoublyLinkedList;
...
public class HomeMadeDoublyLinkedList<T extends Number & Comparable<T>> implements Iterable<T> {
    private DoubleNode<T> myRoot;
    public static class DoubleNode<T> {
            public DoubleNode<T> myNext;
    ...
    public void printList() {
        for (DoubleNode c = myRoot; c != null; c = c.myNext)
    ...
    public int getCount() {
        int cnt = 0;
        for (DoubleNode c = myRoot; c != null; c = c.myNext) cnt++;
        return cnt;
    }
    ...
    public boolean add(T num, int spot) {
        ...
        DoubleNode n = new DoubleNode(num);
        n.myNext = c.myNext;
        c.myNext = n;
        c.myNext.prev = n;
        return true;
    ...
    public int countLess10() {
        int cnt = 0;
        for (DoubleNode<T> c = myRoot; c != null; c = c.myNext)
    ...
    public T getNum(int pos) {
        return getSpot(pos) == null ? null : getSpot(pos);
    }

    public HomeMadeDoublyLinkedList<T> getReverse() {
        HomeMadeDoublyLinkedList<T> r = new HomeMadeDoublyLinkedList<>();
        for (DoubleNode<T> c = myRoot; c != null; c = c.myNext) r.addfront(c.getData());
        return r;
    }
