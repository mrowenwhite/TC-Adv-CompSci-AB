...
public class BigDBLLmain {


    public static void main(String[] args) {
        HomeMadeDoublyLinkedList<Integer> ll = new HomeMadeDoublyLinkedList<>();

        for (int i = 0; i < 10; i++) ll.addfront(i);
        System.out.print("addfront/initial list: ");
        ll.printList();
        ...
        HomeMadeDoublyLinkedList<Integer> rev = ll.getReverse();
        ...
        System.out.print("list after lose58: ");
        ll.printList();

        System.out.println("getEvenCount: " + ll.getEvenCount());

        ll.killOdds();
        System.out.print("killOdds: ");
        ll.printList();
